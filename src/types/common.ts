...
export const ClientResponseSchema = z.object({
  ...
  customFields: z.record(z.string(), z.union([z.string().nullable(), z.array(z.string()).nullable()]).nullable()).nullish(),
});
...
export const ClientRequestSchema = z.object({
  ...
  customFields: z.record(z.union([z.string().nullish(), z.array(z.string()).nullish()]).nullable()).nullish(),
});
